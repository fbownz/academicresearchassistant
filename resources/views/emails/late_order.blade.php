        ...
        <section class="content">
            ...
            <div class="box box-success">
                <div class="box-header no-border">
                    ...
                    This is to remind you that you are late with Order <b>#{{$order->order_no}}</b><br>

                </div>
                <div class="box-body">
                    <p>
                    	In light of this, a 10% fine will be deducted from your total compensation for this order. <br>
