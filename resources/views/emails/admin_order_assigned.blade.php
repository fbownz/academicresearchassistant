        ...
        <section class="content">
            ...
            <div class="box box-success">
                <div class="box-header no-border">
                    <h4>Greetings</h4>
                    Order <b><a href="http://academicresearchassistants.com/orders/{{$order->id}}>#{{$order->order_no}}"</a></b> has successfully been assigned.
                    
                    <br>
                    Kindly confirm this, and make sure the writer has been assigned Successfully.
                </div>
